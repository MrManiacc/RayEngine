...
public class Input {
    ...
    public static final Vector2d previousPos = new Vector2d(-1, -1);
    ...
    private static IWindow windowRef;
    ...
    public static void setCursorDisabled(boolean disabled) {
        GLFW.glfwSetInputMode(window, GLFW_CURSOR, disabled ? GLFW_CURSOR_DISABLED : GLFW_CURSOR_NORMAL);
    }
    ...
    public static GLFWCursorPosCallback mousePos = new GLFWCursorPosCallback() {
        ...
        public void invoke(long window, double x, double y) {
            mousePosition.x = x / windowRef.getWidth();
            mousePosition.y = y / windowRef.getHeight();
        }
    };
    ...
    public static void init(IWindow window) {
        ...
        Input.windowRef = window;
        glfwSetKeyCallback(window.getHandle(), keyboard);
        ...
        glfwSetCursorPosCallback(window.getHandle(), mousePos);
